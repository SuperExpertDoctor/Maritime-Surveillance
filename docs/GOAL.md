...
1. **环境引擎**：300km×300km 海域，30×30 网格（cell=10km），含基地、障碍物（雷云、岛屿）、敌方船舶
...
UAV 发现船舶目标后，切换为跟踪模式，**开启光电传感器（EO/IR）**，绕目标做持续盘旋监视。与 SAR 搜索不同——SAR 需要严格的直线飞行约束，而 EO 跟踪需要 UAV 维持在目标周围的圆形轨道上。
