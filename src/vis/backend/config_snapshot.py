...
def configuration_snapshot(cfg):
    return {
        ...
        "ship": {
            ...
            "opponent_population": {
                "enabled": cfg.ship.opponent_population.enabled,
                "max_active": cfg.ship.opponent_population.max_active,
                "max_active_type_i": cfg.ship.opponent_population.max_active_type_i,
                "max_active_type_ii": cfg.ship.opponent_population.max_active_type_ii,
                "interval_min_min": cfg.ship.opponent_population.interval_min_min,
                "interval_max_min": cfg.ship.opponent_population.interval_max_min,
                "type_i_probability": cfg.ship.opponent_population.type_i_probability,
            },
